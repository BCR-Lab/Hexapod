...
void ClawClass::close(int left_dest, int right_dest){
...
void ClawClass::horizontalMovement(int dest) {
  writeToServo(LEFT_RIGHT, dest);
}
void ClawClass::verticalMovement(int dest){
